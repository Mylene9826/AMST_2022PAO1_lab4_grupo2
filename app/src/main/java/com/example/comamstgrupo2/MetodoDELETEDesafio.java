...
public class MetodoDELETEDesafio extends AppCompatActivity {
    Button btnDelete;
    Spinner spn_temps;
    String delete="";
    int posicion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_metodo_deletedesafio);
    ...
    public void volverMenuPrincipal(View view){
        finish();
        Intent intent = new Intent(MetodoDELETEDesafio.this,MainActivity.class);
